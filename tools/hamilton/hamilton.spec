...
"""
PyInstaller spec for Hamilton STAR Driver

BUILD REQUIREMENTS:
- Python 3.9 (32-bit) - REQUIRED for Hamilton runtime compatibility
- Windows only
- Create venv with 32-bit Python
- Install: pip install pyinstaller grpcio grpcio-reflection protobuf pydantic

BUILD COMMAND:
    pyinstaller hamilton.spec --clean --noconfirm
"""
...
hiddenimports = [
    ...
    'tools',
    'tools.hamilton',
    'tools.hamilton.server',
    'tools.hamilton.driver',
    'tools.base_server',
