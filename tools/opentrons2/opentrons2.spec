...
"""
PyInstaller spec for Opentrons OT-2 Driver

BUILD REQUIREMENTS:
- Python 3.9
- Create venv with appropriate Python version
- Install: pip install pyinstaller grpcio grpcio-reflection protobuf requests pydantic

BUILD COMMAND:
    pyinstaller opentrons2.spec --clean --noconfirm
"""
...
hiddenimports = [
    ...
    'tools',
    'tools.opentrons2',
    'tools.opentrons2.server',
    'tools.opentrons2.driver',
    'tools.base_server',
