...
"""
PyInstaller spec for ALPS 3000 Driver
...
BUILD COMMAND:
    pyinstaller alps3000.spec --clean --noconfirm
"""
...
hiddenimports = [
    ...
    'tools',
    'tools.alps3000',
    'tools.alps3000.server',
    'tools.alps3000.driver',
    'tools.base_server',
...
exe = EXE(
    ...
    strip=False,
    upx=True,
    console=True,  # Keep True for debugging output
