...
"""
PyInstaller spec for PLR (PyLabRobot) Driver

BUILD REQUIREMENTS:
- Python 3.9
- Create venv with appropriate Python version
- Install: pip install pyinstaller grpcio grpcio-reflection protobuf pydantic PyLabRobot

BUILD COMMAND:
    pyinstaller plr.spec --clean --noconfirm
"""
