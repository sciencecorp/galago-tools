...
"""
PyInstaller spec for PyHamilton Driver

BUILD REQUIREMENTS:
- Python 3.9 (32-bit) - REQUIRED for Hamilton runtime
- Windows only
- Create venv with 32-bit Python
- Install: pip install pyinstaller grpcio grpcio-reflection protobuf pydantic pyhamilton

BUILD COMMAND:
    pyinstaller pyhamilton.spec --clean --noconfirm
"""
